...
CREATE TABLE IF NOT EXISTS imported_sources (
  ...
  last_error TEXT,
  original_source_required INTEGER NOT NULL DEFAULT 1,
  moderation_required INTEGER NOT NULL DEFAULT 1,
  notes TEXT,
...
CREATE TABLE IF NOT EXISTS imported_items (
  ...
  auto_archive_after_expiry INTEGER NOT NULL DEFAULT 1,
  renewal_count INTEGER NOT NULL DEFAULT 0,
  last_renewed_at TEXT,
  duplicate_hash TEXT,
  raw_import_payload TEXT,
  approved_by TEXT,
  approved_at TEXT,
