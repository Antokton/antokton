  ...
  return (
    <>
      ...
      <nav className="fixed left-0 right-0 z-40 flex items-start justify-between overflow-hidden bg-[#0b1020] border-t border-white/10 px-1 md:hidden"
        style={{ bottom: 0, height: 'calc(58px + var(--app-safe-bottom))', paddingBottom: 'var(--app-safe-bottom)', paddingTop: 4, transform: 'translateZ(0)', willChange: 'transform', WebkitTransform: 'translateZ(0)' }}>
        {activeTabs.map(tab => {
