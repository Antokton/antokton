...
Kthe JSON me këto fusha.`;
  ...
  const save = async (status) => {
    ...
    const payload = {
      ...
      professional_relevance_score: prepared.professional_relevance_score,
      source_trust_score: prepared.source_trust_score,
      hallall_score: prepared.hallall_score,
      ethical_score: prepared.ethical_score,
      freshness_score: prepared.freshness_score,
      completeness_score: prepared.completeness_score,
      final_score: prepared.final_score,
      source_priority_level: prepared.source_priority_level,
      source_profile: prepared.source_profile,
      source_bonus_allowed: prepared.source_bonus_allowed,
      risk_level: prepared.risk_level,
      requires_manual_review: prepared.requires_manual_review,
      quality_notes: prepared.quality_notes,
      communication_languages: prepared.communication_languages,
      show_communication_language: prepared.show_communication_language,
      status,
