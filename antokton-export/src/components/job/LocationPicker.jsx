...
const ANTOKTON_ZONES = {
  "Rajoni Verior — Dardhania": [
    "Bujanovc","Ferizaj","Gjakovë","Gjilan","Kaçanik","Kratovë","Kriva Pallankë","Kumanovë",
    "Leskovac","Medvegjë","Mitrovicë","Nish","Pejë","Podujevë","Preshevë","Prijepolje",
...
const ANTOKTON_PLACES = [
  ...
  { name: "Muriqan", aliases: ["muriqan","murican"], zone: "Rajoni Perëndimor — Iliria", city: "Muriqan", near: "Shkodër" },
  { name: "Gruemirë", aliases: ["gruemire","grubisic"], zone: "Rajoni Perëndimor — Iliria", city: "Gruemirë", near: "Guci" },
  { name: "Zatriç", aliases: ["zatric","zatriç"], zone: "Rajoni Perëndimor — Iliria", city: "Zatriç", near: "Plavë" },
  { name: "Vrith", aliases: ["vrith","vrit"], zone: "Rajoni Perëndimor — Iliria", city: "Vrith", near: "Ulqin" },
  { name: "Arbnesh", aliases: ["arbnesh","arbanese"], zone: "Rajoni Perëndimor — Iliria", city: "Arbnesh", near: "Tivar" },
  { name: "Briska e Madhe", aliases: ["briska e madhe","velika briska"], zone: "Rajoni Perëndimor — Iliria", city: "Briska e Madhe", near: "Ulqin" },
  { name: "Hot", aliases: ["hot","hoti"], zone: "Rajoni Perëndimor — Iliria", city: "Hot", near: "Guci" },
  { name: "Triesh", aliases: ["triesh","triesch"], zone: "Rajoni Perëndimor — Iliria", city: "Triesh", near: "Plavë" },
  // Kosovë — fshatra
  { name: "Ibar", aliases: ["ibar","ibare"], zone: "Rajoni Verior — Dardhania", city: "Ibar", near: "Mitrovicë" },
  { name: "Banjë", aliases: ["banje","banja"], zone: "Rajoni Verior — Dardhania", city: "Banjë", near: "Pejë" },
  { name: "Bresalc", aliases: ["bresalc","brezovica"], zone: "Rajoni Verior — Dardhania", city: "Bresalc", near: "Ferizaj" },
  { name: "Kamenicë", aliases: ["kamenice","kamenica"], zone: "Rajoni Verior — Dardhania", city: "Kamenicë", near: "Gjilan" },
  { name: "Lipjan", aliases: ["lipjan","lipljan"], zone: "Rajoni Verior — Dardhania", city: "Lipjan", near: "Prishtinë" },
  { name: "Drenas", aliases: ["drenas","glogovac"], zone: "Rajoni Verior — Dardhania", city: "Drenas", near: "Prishtinë" },
  { name: "Rahovec", aliases: ["rahovec","orahovac"], zone: "Rajoni Verior — Dardhania", city: "Rahovec", near: "Gjakovë" },
  { name: "Skenderaj", aliases: ["skenderaj","srbica"], zone: "Rajoni Verior — Dardhania", city: "Skenderaj", near: "Mitrovicë" },
  { name: "Malishevë", aliases: ["malisevo","malisheve"], zone: "Rajoni Verior — Dardhania", city: "Malishevë", near: "Prizren" },
  { name: "Suharekë", aliases: ["suhareka","suhareke","suva reka"], zone: "Rajoni Verior — Dardhania", city: "Suharekë", near: "Prizren" },
  { name: "Obiliq", aliases: ["obilic","obiliq"], zone: "Rajoni Verior — Dardhania", city: "Obiliq", near: "Prishtinë" },
  { name: "Deçan", aliases: ["decan","decane"], zone: "Rajoni Verior — Dardhania", city: "Deçan", near: "Pejë" },
  { name: "Klinë", aliases: ["kline","klina"], zone: "Rajoni Verior — Dardhania", city: "Klinë", near: "Pejë" },
  { name: "Dragash", aliases: ["dragash","dragas"], zone: "Rajoni Verior — Dardhania", city: "Dragash", near: "Prizren" },
  { name: "Leposaviq", aliases: ["leposavic","leposaviq"], zone: "Rajoni Verior — Dardhania", city: "Leposaviq", near: "Mitrovicë" },
  // Maqedoni e Veriut — vendbanime shqiptare
  { name: "Çegran", aliases: ["cegran","chegran"], zone: "Rajoni Lindor — Thesalia & Maqedonia", city: "Çegran", near: "Gostivar" },
  { name: "Jegunovcë", aliases: ["jegunovce","jegunovtse"], zone: "Rajoni Lindor — Thesalia & Maqedonia", city: "Jegunovcë", near: "Shkup" },
  { name: "Saraj", aliases: ["saraj"], zone: "Rajoni Lindor — Thesalia & Maqedonia", city: "Saraj", near: "Shkup" },
  { name: "Kondovë", aliases: ["kondove","kondovo"], zone: "Rajoni Lindor — Thesalia & Maqedonia", city: "Kondovë", near: "Shkup" },
  { name: "Zhelinë", aliases: ["zheline","zelino"], zone: "Rajoni Lindor — Thesalia & Maqedonia", city: "Zhelinë", near: "Tetovë" },
  { name: "Bogovinë", aliases: ["bogovinje","bogovine"], zone: "Rajoni Lindor — Thesalia & Maqedonia", city: "Bogovinë", near: "Tetovë" },
  { name: "Vrapçisht", aliases: ["vrapcist","vrapchisht"], zone: "Rajoni Lindor — Thesalia & Maqedonia", city: "Vrapçisht", near: "Gostivar" },
  { name: "Debar", aliases: ["debar","diber"], zone: "Rajoni Lindor — Thesalia & Maqedonia", city: "Debar", near: "Dibër" },
...
const STREET_SUGGESTIONS = [
  // Prishtinë
  { label: "Rr. Nënë Tereza, Prishtinë", city: "Prishtinë", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  { label: "Rr. UÇK, Prishtinë", city: "Prishtinë", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  { label: "Rr. Ali Ajeti, Prishtinë", city: "Prishtinë", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  { label: "Rr. Bill Clinton, Prishtinë", city: "Prishtinë", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  { label: "Lagja Dardania, Prishtinë", city: "Prishtinë", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  { label: "Lagja Kalabria, Prishtinë", city: "Prishtinë", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  { label: "Lagja Matiqan, Prishtinë", city: "Prishtinë", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  { label: "Lagja Bregu i Diellit, Prishtinë", city: "Prishtinë", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  { label: "Qendra, Prishtinë", city: "Prishtinë", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  // Tiranë
  { label: "Rr. Myslym Shyri, Tiranë", city: "Tiranë", zone: "Rajoni Perëndimor — Iliria", country: "Antokton", is_antokton: true },
  { label: "Rr. Kavajës, Tiranë", city: "Tiranë", zone: "Rajoni Perëndimor — Iliria", country: "Antokton", is_antokton: true },
  { label: "Blloku, Tiranë", city: "Tiranë", zone: "Rajoni Perëndimor — Iliria", country: "Antokton", is_antokton: true },
  { label: "Yzberisht, Tiranë", city: "Tiranë", zone: "Rajoni Perëndimor — Iliria", country: "Antokton", is_antokton: true },
  { label: "Kombinat, Tiranë", city: "Tiranë", zone: "Rajoni Perëndimor — Iliria", country: "Antokton", is_antokton: true },
  { label: "Qyteti Studenti, Tiranë", city: "Tiranë", zone: "Rajoni Perëndimor — Iliria", country: "Antokton", is_antokton: true },
  { label: "Astir, Tiranë", city: "Tiranë", zone: "Rajoni Perëndimor — Iliria", country: "Antokton", is_antokton: true },
  { label: "Selitë, Tiranë", city: "Tiranë", zone: "Rajoni Perëndimor — Iliria", country: "Antokton", is_antokton: true },
  // Shkup
  { label: "Çair, Shkup", city: "Shkup", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  { label: "Butel, Shkup", city: "Shkup", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  { label: "Qendra, Shkup", city: "Shkup", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  { label: "Gjorçe Petrov, Shkup", city: "Shkup", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  // Tetovë
  { label: "Qendra, Tetovë", city: "Tetovë", zone: "Rajoni Lindor — Thesalia & Maqedonia", country: "Antokton", is_antokton: true },
  { label: "Rr. Ilinden, Tetovë", city: "Tetovë", zone: "Rajoni Lindor — Thesalia & Maqedonia", country: "Antokton", is_antokton: true },
  // Gjakovë
  { label: "Çarshia e Vjetër, Gjakovë", city: "Gjakovë", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  { label: "Qendra, Gjakovë", city: "Gjakovë", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  // Prizren
  { label: "Qendra Historike, Prizren", city: "Prizren", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  { label: "Rr. Shën Flori, Prizren", city: "Prizren", zone: "Rajoni Verior — Dardhania", country: "Antokton", is_antokton: true },
  // Shkodër
  { label: "Qendra, Shkodër", city: "Shkodër", zone: "Rajoni Perëndimor — Iliria", country: "Antokton", is_antokton: true },
  { label: "Rus, Shkodër", city: "Shkodër", zone: "Rajoni Perëndimor — Iliria", country: "Antokton", is_antokton: true },
  // Durrës
  { label: "Qendra, Durrës", city: "Durrës", zone: "Rajoni Perëndimor — Iliria", country: "Antokton", is_antokton: true },
  { label: "Shkozet, Durrës", city: "Durrës", zone: "Rajoni Perëndimor — Iliria", country: "Antokton", is_antokton: true },
  // Janinë / Epir
